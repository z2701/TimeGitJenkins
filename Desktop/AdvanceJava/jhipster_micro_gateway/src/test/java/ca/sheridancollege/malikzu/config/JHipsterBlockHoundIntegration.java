...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ca.sheridancollege.malikzu.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ca.sheridancollege.malikzu.security.DomainUserDetailsService", "createSpringSecurityUser");
